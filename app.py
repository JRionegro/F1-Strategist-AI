...
def initialize_session() -> GlobalSession:
    ...
    if "global_session" not in st.session_state:
        ...
        logger.info(f"Global session initialized with {race_context.country} GP (Round {race_context.round_number}, {race_context.year})")
...
def main():
    ...
    if menu_selection == "Dashboards":
        ...
        config = TopMenu.render_configuration_panel()
